...
// A split payment needs every leg confirmed before the bill is actually settled — PaymentService
// only flips bill.status to "paid" once the sum of paid legs covers the full amount, so this route
// just checks that status rather than assuming any single confirm means "the bill is done".
