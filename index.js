...
app.post("/api/hardware/devices/:id/config/relay", requireHardwareAdmin, hardwareRoute(req => hardwareService.setRelayCount(req.params.id, req.body?.relayCount, actorId(req))));
