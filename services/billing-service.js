...
class BillingService {
  ...
  createBillDraft({ table, session, memberName = "ลูกค้าทั่วไป", memberCode = null, actorId = "SYSTEM", extraItems = [], tableSessionId = null, posOrderIds = [], breakdown = null, discountReason = "", partialOrdersOnly = false, saleSource = "TABLE" }) {
